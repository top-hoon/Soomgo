    ...
    return(
        ...
        <div className="pro-signup">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12">
                            ...
                            <p className="headline"> 많은 고객들이 조건에 딱! 맞는 고수를 찾고 있어요. 고객에게 필요한 딱! 맞는 고수가 되어보세요. </p>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-4">
                            <h3>9,941,032</h3>
                            <p className="label-count">누적 요청서</p>
                        </div>
                        <div className="col-4">
                            <h3>720,093</h3>
                            <p className="label-count">등록된 고수</p>
                        </div>
                        <div className="col-4">
                            <h3>4.9 / 5점</h3>
                            <p className="label-count">평균 리뷰별점</p>
                        </div>
                    </div>
                </div>
            </div>
            <div id="operation">
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12">
                            <a href="/#" className="btn btn-primary btn-lg" target="_self">더 알아보기</a>
                        </div>
                    </div>
                </div>
            </div>
            <div data-v-2cebe516 data-v-7d8e81a2 id="testimonial">
                <div data-v-2cebe516 className="container">
                    <div data-v-2cebe516 className="row">
                        <div data-v-2cebe516 className="col-12">
                            <h2 data-v-2cebe516>숨은 고수들의 생생한 후기</h2>
                        </div>
                    </div>
                    <div data-v-0efc47ab data-v-2cebe516 className="testimonial-summary-list-comp">
                        <div data-v-22f5ed86 data-v-0efc47ab className="summary-list slick-initialized slick-slider slick-dotted">
                            <div className="slick-list draggable">
                                <div className="slick-track" style={slickTrack}>
                                    <div className="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                                        <div data-v-01f026ba data-name="provider" style={image1}>
                                                            <div data-v-01f026ba data-name="provider-info" className="hidden-xs">
                                                                <h2 data-v-01f026ba>바느질/재봉틀 레슨</h2>
                                                                <h3 data-v-01f026ba>박현주</h3>
                                                            </div>
                                                        </div>
                                                        <div data-v-01f026ba data-name="provider-info" className="visible-xs">
                                                            <h2 data-v-01f026ba>바느질/재봉틀 레슨</h2>
                                                            <h3 data-v-01f026ba>박현주</h3>
                                                        </div>
                                                        <div data-v-01f026ba data-name="content" className="col-xs-12 col-sm-10">
                                                            <p  data-v-01f026ba>처음 숨고 시작했을 때보다 요청 양이 많이 늘어난 것 같아요. 계속 이렇게 숨고가 번창해서 요청이 늘어난다면 회사를 그만두고 이 쪽에 전념해야 하나 고민될 정도에요!</p>
                                                        </div>
                                                        <a data-v-01f026ba className="view-more">더보기</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                                        ...
                                                        <div data-name="provider-info" className="visible-xs">
                                                            <h2 data-v-01f026ba>드럼 레슨</h2>
                                                            <h3 data-v-01f026ba>김정욱</h3>
                                                        </div>
                                                        <div data-v-01f026ba data-name="content" className="col-xs-12 col-sm-10">
                                    ...
                                    <div className="slick-slide" data-slick-index="1" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide" data-slick-index="2" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide" data-slick-index="3" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide slick-cloned" data-slick-index="6" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12" style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
                                    ...
                                    <div className="slick-slide slick-cloned" data-slick-index="7" aria-hidden="true" style={{width: '970px'}}>
                                        <div>
                                            <div data-v-0efc47ab className="col-sm-12"  style={{width: '100%', display: 'inline-block'}}>
                                                <div data-v-01f026ba data-v-0efc47ab className="s-card testimonial-summary">
                                                    <div data-v-01f026ba className="row">
            ...
            <div id="clip">
                <div className="container">
                    <div className="row">
                        <div className="clip-title col-12">
                            <h2>고수 성공 스토리</h2>
                            <p className="headline">숨고를 통해 성공한 고수의 스토리를 들어보세요.</p>
                        </div>
                    </div>
                    <div className="row clip-row">
                        <div className="clip-wrap lg">
                            <div className="clip-bg clip-bg-04">
                        ...
                        <div className="clip-wrap">
                            <div className="clip-bg clip-bg-05">
                                <img src="data:image/png;base64," alt="재생" />
                                <h3> 이사 <small>박환준 고수</small></h3>
                            </div>
                        </div>
                        <div className="clip-wrap">
                            <div className="clip-bg clip-bg-06">
                                <img src="data:image/png;base64," alt="재생"/>
                                <h3> 웨딩플래너 <small>이성희 고수</small></h3>
                            </div>
                        </div>
                        <div className="clip-wrap">
                            <div className="clip-bg clip-bg-07">
                                <img src="data:image/png;base64," alt="재생" />
                                <h3> 청소도우미 <small>이은혜 고수</small></h3>
                            </div>
                        </div>
                        <div className="clip-wrap double-width">
                            <div className="clip-bg clip-bg-09">
                                <img src="data:image/png;base64," alt="재생"/>
